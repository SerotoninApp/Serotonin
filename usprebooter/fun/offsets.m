...
void _offsets_init(void) {
    if (!(SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"16.0") && SYSTEM_VERSION_LESS_THAN(@"16.7")) || !(SYSTEM_VERSION_EQUAL_TO(@"15.5"))) {
        printf("[-] Only supported offset for iOS 15.5, 16.0-16.6.1\n");
        exit(EXIT_FAILURE);
    }
    ...
    if(SYSTEM_VERSION_EQUAL_TO(@"15.5")) {
        ...
        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/filedesc.h#L137
        //same as xnu-8792.41.9
        off_fd_ofiles = 0;
        off_fd_cdir = 0x20;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/file_internal.h#L124
        //same as xnu-8792.41.9
        off_fp_glob = 0x10;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/file_internal.h#L178
        //same as xnu-8792.41.9
        off_fg_flag = 0x10;
        off_fg_data = 0x38;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/vnode_internal.h#L142
        //same as xnu-8792.41.9
        ...
        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/mount_internal.h#L107
        //same as xnu-8792.41.9
        ...
        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/miscfs/specfs/specdev.h#L77
        //same as xnu-8792.41.9
        off_specinfo_si_flags = 0x10;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/namei.h#L243
        //same as xnu-8792.41.9
        ...
        //same as xnu-8792.41.9
        off_ubc_info_cs_blobs = 0x50;   //_ubc_cs_blob_get
        off_ubc_info_cs_add_gen = 0x2c;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/bsd/sys/ubc_internal.h#L102
        //Doesn't exist, profile_kaddr & profile_allocation_size are there instead FIXME:
        //off_cs_blob_csb_pmap_cs_entry = 0x0;
        ...
        off_pmap_cs_code_directory_der_entitlements_size = 0;
        off_pmap_cs_code_directory_trust = 0;
        */

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/osfmk/ipc/ipc_entry.h#L111
        //same as xnu-8792.41.9
        off_ipc_entry_ie_object = 0;

        //https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/osfmk/ipc/ipc_object.h#L116
        //same as xnu-8792.41.9
        off_ipc_object_io_bits = 0;
        off_ipc_object_io_references = 0x4;

        ////https://github.com/apple-oss-distributions/xnu/blob/xnu-8020.121.3/osfmk/ipc/ipc_port.h#L167
        //https://github.com/0x7ff/dimentio/blob/7ffffffb4ebfcdbc46ab5e8f1becc0599a05711d/libdimentio.c#L973
        //same as xnu-8792.41.9
