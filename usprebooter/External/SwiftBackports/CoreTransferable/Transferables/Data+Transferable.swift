...
//extension Data: BackportTransferable, @unchecked Sendable {
//
//    /// The representation used to import and export the item.
//    ///
//    /// A ``transferRepresentation`` can contain multiple representations
//    /// for different content types.
//    public static var transferRepresentation: some BackportTransferRepresentation {
//        fatalError()
//    }
//
...
//    public typealias Representation = some BackportTransferRepresentation
//}
